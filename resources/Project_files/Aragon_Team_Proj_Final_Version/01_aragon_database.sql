...
CREATE DATABASE aragon
	...
	(
		...
		FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Aragon_Team_Project_final_version\aragon.mdf' -- define directory for primary file group
		)
	LOG ON
	...
	(
		...
		FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Aragon_Team_Project_final_version\aragon_log.ldf' -- define the path for the log file
		);
GO
